...
export const STATIC_ROUTES: StaticRoute[] = [
  ...
  { label: "QR Code for Business",                                 path: "/qr-code-generator-for-business",                             changeFrequency: "monthly", priority: 0.8 },
  { label: "WiFi QR Code Free",                                    path: "/create-wifi-qr-code-free",                                   changeFrequency: "monthly", priority: 0.8 },
  { label: "QR Code with Logo Free",                               path: "/create-qr-code-with-logo-free",                              changeFrequency: "monthly", priority: 0.8 },
  { label: "Download QR Code PNG SVG PDF",                         path: "/download-qr-code-png-svg-pdf",                               changeFrequency: "monthly", priority: 0.8 },
