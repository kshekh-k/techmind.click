  ...
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outlineLime: "border border-lime-500 text-lime-600 hover:bg-lime-500 hover:text-white",
        outlineCyan: "border border-cyan-500 text-cyan-600 hover:bg-cyan-500 hover:text-white",
        outlineAmber: "border border-amber-500 text-amber-600 hover:bg-amber-500 hover:text-white",
