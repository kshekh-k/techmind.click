        ...
        <div className="container mx-auto px-4 py-8">
            <Card className="max-w-4xl mx-auto">
                <CardHeader>
                    ...
                    <p className="text-muted-foreground">Last updated: May 04, 2025</p>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                    ...
                    <section className="">
                        ...
                        <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>Make any unauthorized use of the Services, including collecting usernames and/or email addresses of users for the purpose of sending unsolicited email.</li>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">7. ADVERTISERS</h2>
                        <p>
                    ...
                    <section className="">
                        ...
                        <p>
                            We care about data privacy and security. Please review our Privacy Policy: <a href="/privacy-policy" className="text-blue-600 hover:underline">www.techmind.click/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.
                        </p>
                    </section>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">11. MODIFICATIONS AND INTERRUPTIONS</h2>
                        <p>
                    ...
                    <section className="">
                        ...
                        <p>
                            These Legal Terms shall be governed by and defined following the laws of India. Technind.click and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
                        </p>
                    </section>
                    ...
                    <section className="">
                        ...
                        <p>
                            Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC. The number of arbitrators shall be three (3). The seat, or legal place, or arbitration shall be Jaipur, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.
                        </p>

                        <h3 className="text-xl font-semibold mb-2 mt-6">Restrictions</h3>
                        <p>
                            The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
                        </p>

                        <h3 className="text-xl font-semibold mb-2 mt-6">Exceptions to Informal Negotiations and Arbitration</h3>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">14. CORRECTIONS</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">15. DISCLAIMER</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">16. LIMITATIONS OF LIABILITY</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">18. USER DATA</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">19. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">20. CALIFORNIA USERS AND RESIDENTS</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">21. MISCELLANEOUS</h2>
                        <p>
                    ...
                    <section className="">
                        <h2 className="text-2xl font-bold mb-4">22. CONTACT US</h2>
                        <p>
                            In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
                        </p>
                        <address className="not-italic mt-4">
                            <strong>Technind.click</strong><br />
                            <strong>info@techmind.click</strong>
                        </address>
                    </section>
                </CardContent>
            </Card>
